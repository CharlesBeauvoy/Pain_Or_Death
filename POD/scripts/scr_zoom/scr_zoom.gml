...
camera_set_view_pos(view_camera[0],
				clamp(mouse_coor_x-camera_get_view_width(view_camera[0])/2,0,room_width-zoom_width),
				clamp(mouse_coor_y-camera_get_view_height(view_camera[0])/2,0,room_height-zoom_height));
/*
if amount < 1
{
